...
The exact value of $C$ used for each detector was 4~ns minus the time corresponding to the TDC channel that contained the peak of the target-induced gamma flash.
...
This assumption is validated through MCNP simulations that tested the frequency of the scattering of fission neutrons within the target and detector shielding, and is discussed in sections~\ref{subsection:targets} and \ref{subsection:detectors}, respectively.
Figure~\ref{fig:ErgUncertainty}(a) shows the relationship between neutron energy and ToF, and Figure~\ref{fig:ErgUncertainty}(b) shows the measured neutron energy uncertainty after the propagation of ToF measurement uncertainty through the calculation of neutron energy.
\begin{figure}[]
...
\begin{figure}[]
    \centering
    \subfloat[]{\includegraphics[width=0.65\textwidth]{Content/Methods/PMTDifference_hist.png}}
    
    \subfloat[]{\includegraphics[width = 0.65\textwidth]{Content/Methods/PMTDifference.png}}
