...
\begin{figure}[h]
\centering
\hbox{\hspace{3.25em}\subfloat[]{\includegraphics[width=0.6\textwidth]{Content/Methods/ConstPMTAvg.png}}}
...
\begin{figure}[]
    \centering
    \subfloat[]{\includegraphics[width=0.7\textwidth]{Content/Methods/PMTDifference_hist.png}}
    
    \subfloat[]{\includegraphics[width = 0.70\textwidth]{Content/Methods/PMTDifference.png}}
...
%ToDO: picture of targets
\label{subsection:targets}
\begin{figure}[]
\centering
    \subfloat[]{\includegraphics[width=0.47\textwidth]{Content/Methods/MTvsAl.png}}
    \subfloat[]{\includegraphics[width=0.47\textwidth]{Content/Methods/DUvsAl.png}}
