...
Furthermore, \textit{accidental} two-neutron events, which are when two causally uncorrelated events occur in the same pulse and both appear to be neutrons, can be subtracted from the data.
